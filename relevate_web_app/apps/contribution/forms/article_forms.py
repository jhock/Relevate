...
class ArticleCreateForm(forms.Form):
	...
	url_image = forms.CharField(
		max_length=1000,
		label='Image From Url',
		widget=forms.TextInput(attrs={'placeholder': 'Paste the Url of the image here', 'class': 'form-control'}),
		required=False)

	content = forms.CharField(
		max_length=10000,
		label='Article Content',
		widget=forms.Textarea(attrs={'placeholder': 'Insert Article Here', 'class': 'form-control'}),
		required=True)
	...
	references = forms.CharField(
		max_length=3000,
		label='Article References (if any)',
